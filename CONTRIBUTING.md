...
- Submit an issue on the [Issues
  page](https://github.com/ropensci/brranching/issues)
...
- Clone your version on your account down to your machine from your
  account, e.g,.
  `git clone https://github.com/<yourgithubusername>/brranching.git`
- Make sure to track progress upstream (i.e., on our version of
  `brranching` at `ropensci/brranching`) by doing
  `git remote add upstream https://github.com/ropensci/brranching.git`.
...
## Prefer to Email? Get in touch: <myrmecocystus@gmail.com>
